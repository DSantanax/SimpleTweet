...
import com.codepath.apps.restclienttemplate.models.TweetImg;
...
public class TweetsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public TweetsAdapter(Context context, List<Object> tweets){
...
//        holder.bind(tweet);
    ...
    // add a list of items
    public void addAll(List<Object> newTweets) {
